...
from mirage.utils.device_dtype_mixin import DeviceDtypeModuleMixin
...
# CT hack: remap phys_anim to mirage for backwards compatibility of pre-existing motion files
import sys
import mirage

sys.modules['phys_anim'] = mirage
