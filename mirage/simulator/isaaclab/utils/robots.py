...
SMPLX_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="mirage/data/assets/usd/smplx_humanoid.usda",
...
SMPL_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="mirage/data/assets/usd/smpl_humanoid.usda",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
H1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="mirage/data/assets/usd/h1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
G1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="mirage/data/assets/usd/g1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
        ...
        articulation_props=sim_utils.ArticulationRootPropertiesCfg(
            enabled_self_collisions=Config.enabled_self_collisions,
            fix_root_link=False,
            solver_position_iteration_count=4,
            solver_velocity_iteration_count=4,
        ),
